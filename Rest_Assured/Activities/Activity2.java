...
public class Activity2Test{
    ...
    public void getUserInfo() {
        ...
        response.then().body("username", equalTo("Vani"));
        response.then().body("firstName", equalTo("Bhovi"));
        response.then().body("lastName", equalTo("B"));
        response.then().body("email", equalTo("Bhovi@amail.com"));
        response.then().body("password", equalTo("Bhovi123"));
    ...
    public void deleteUser() throws IOException {
        ...
        response.then().body("code", equalTo(200));
        response.then().body("message", equalTo("Bhovi012"));
    }
}